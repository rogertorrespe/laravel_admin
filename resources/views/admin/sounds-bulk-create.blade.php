                            ...
                            <div class="col-lg-12 col-md-12">
                                ...
                                <div class="form-group row">
                                    ...
                                    <?php
                                        ...
                                        <select class="form-control" name="cat_id[]" id="cat_id2" multiple {{$readonly}}>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label">Active <span class="requried">*</span></label>
                                    <div class="col-sm-8">
                                        <?php
                                        if( old('active')!='' ){
                                            $active = old('active');
