                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link <?php echo ($type=='G') ? 'active' : ''; ?>" id="general_setting_tab" data-toggle="tab" href="#general_settings" role="tab" aria-controls="general_settings" aria-selected="true" data-type="L"> <i class="fa fa-cog"></i> General</a>
                                            </li>
                                        </ul>
                                        <br />
                                                                    ...
                                                                    <div class="form-group row " >
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <select class="form-control" name="video_time_limit[]" id="video_time_limit" multiple required>
                                                                                ...
                                                                                <?php } ?>
                                                                                <!-- <option <?php //echo (in_array("15", $video_time_limit)) ? 'selected' : ''; ?> value="15">15 sec</option>
                                                                                <option <?php //echo (in_array("30", $video_time_limit)) ? 'selected' : ''; ?> value="30">30 sec</option>
                                                                                <option <?php //echo (in_array("45", $video_time_limit)) ? 'selected' : ''; ?> value="45">45 sec</option>
                                                                                <option <?php //echo (in_array("60", $video_time_limit)) ? 'selected' : ''; ?> value="60">60 sec</option> -->
                                                                            </select>
