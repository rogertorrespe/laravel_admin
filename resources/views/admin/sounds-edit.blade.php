...
<section class="rightside-main">
	<div class="container-fluid">
        <div class="page-top">
            ...
            <div class="page-berdcrumb">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a class="active" href="#"><?php echo $title;?> Sound</a>
                    </li>
                </ul>       
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-12 card table-card ">
                            ...
                            <div class="col-lg-12 col-md-12">
                                ...
                                <div class="form-group row">
                                    ...
                                    <?php
                                        ...
                                        <select class="form-control" name="cat_id[]" id="cat_id" multiple <?php echo ($readonly!="") ? 'disabled' : ''; ?> >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row">
                                            ...
                                            @if($image!="")
                                            <img src="<?php echo asset(Storage::url('public/sounds/images/'.$image));?>" width="80px">
                                            @endif
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Sound <span class="requried">*</span> <span class="muted">(Only .mp3 format are allowed)</span></label>
                                    <div class="col-sm-10">
                                        <?php
                                        if( old('sound_name')!='' ){
