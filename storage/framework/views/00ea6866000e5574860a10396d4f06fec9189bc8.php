            <div class=" no-pad">
                ...
                <div class="sidenav overlay mystyle closebar" id="navBar">
                    ...
                    <div >
                        ...
                        <div class="logo-main">
					<a href="<?php echo e(route('admin.dashboard')); ?>"><img src="<?php echo e(MyFunctions::getLogo()); ?>" alt=""  class="logo"/></a>
				</div>
                            <ul class="new-nav">
                                <li>
                                ...
                                <li>
                                    <a href="<?php echo e(route('admin.sounds.index')); ?>" >
                                ...
                                <li data-toggle="collapse" data-target="#users_menu" class="collapsed main_li">
                                  <a href="#"><i class="fa fa-users"></i> Users <span class="arrow"></span></a>
                                    <ul class="sub-menu collapse" id="users_menu">
                                        <li> 
                                            <a href="<?php echo e(route('admin.candidates.index')); ?>/1" >
                                                Active 
                                            </a>
                                        </li>
                                        <li> 
                                            <a href="<?php echo e(route('admin.candidates.index')); ?>/0" >
                                                Inactive 
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li data-toggle="collapse" data-target="#verify_menu" class="collapsed main_li">
                                  <a href="#"><i class="fa fa-users"></i> Account Verification <span class="arrow"></span></a>
                                    <ul class="sub-menu collapse" id="verify_menu">
                                        <li> 
                                            <a href="<?php echo e(route('admin.user-verify.index', ['type'=>'A'])); ?>" >
                                                Verified 
                                            </a>
                                        </li>
                                        <li> 
                                            <a href="<?php echo e(route('admin.user-verify.index', ['type'=>'P'])); ?>" >
                                                Pending 
                                            </a>
                                        </li>
                                        <li> 
                                            <a href="<?php echo e(route('admin.user-verify.index', ['type'=>'R'])); ?>" >
                                                Rejected 
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li >
                                    <a href="<?php echo e(route('admin.flagvideos.index')); ?>" >
                                ...
                                <li data-toggle="collapse" data-target="#settings" class="collapsed main_li">
                                  <a href="<?php echo e(route('admin.settings')); ?>"><i class="fa fa-gear"></i> Settings <span class="arrow"></span></a>
                                 
                                </li> 
                                <li>
                                    <a href="<?php echo e(route('admin.app_config_settings')); ?>">
                                ...
                                <li data-toggle="collapse" data-target="#eng_menu" class="collapsed main_li">
                                  <a href="#"><i class="fa fa-users"></i> Engagement <span class="arrow"></span></a>
                                    <ul class="sub-menu collapse" id="eng_menu">
                                        ...
                                        <li> 
                                            <a href="<?php echo e(route('admin.likes.index')); ?>" >
                                                Likes 
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <!-- <li>
                                    <a href="<?php echo e(route('admin.dashboard')); ?>" ><i class="nav-icons fa fa-home" aria-hidden="true"></i> Dashboard</a>
                                </li>
                                <li>
...
<?php /**PATH D:\Wamp\www\LeukeWebPanel\resources\views/includes/admin/sidebar.blade.php ENDPATH**/ ?>