...
{   
     ...
     var $column_order = array(null,null,'heading','image','title'); //set column field database for datatable orderable
    ...
    {
        $action = 'add';            
        return view('admin.sponsors-create',compact('action'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.sponsors-create',compact('sponsor','id','action'));
    }
