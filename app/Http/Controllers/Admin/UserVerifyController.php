...
{   
    ...
    var $column_order = array(null,null,'name', 'address','verified'); //set column field database for datatable orderable
    ...
    {
        $type=$request->type;
        return view("admin.user-verify",compact('type'));
    }
    ...
    {
        $action = 'add';
        return view('admin.user-verify-create',compact('action'));
    }
