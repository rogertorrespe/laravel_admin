...
{   
     ...
     var $column_order = array(null,null,'title'); //set column field database for datatable orderable
    ...
    {
        $action = 'add';            
        return view('admin.page-create',compact('action'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.page-create',compact('page','id','action'));
    }
     ...
     public function serverProcessing(Request $request)
    {
        ...
        foreach ($list as $content) {
            $no++;
            $row = array();
            $row[] = '<a class="view" href="'.$currentPath.$content->page_id.'/'.'view"><i class="fa fa-search"></i></a><a class="edit" href="'.$currentPath.$content->page_id.'/edit"><i class="fa fa-edit"></i></a><a class="delete deleteSelSingle" style="cursor:pointer;" data-val="'.$content->page_id.'"><i class="fa fa-trash"></i></a>';
