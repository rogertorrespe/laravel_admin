...
Route::group(['prefix' => 'v1','namespace'=>'API'],function(){
	...
	Route::group(['middleware' => 'api_check'], function(){
		...
		Route::post('chats', 'ChatController@listing')->name('chats');
		Route::post('store-msg', 'ChatController@storeMsg')->name('store-msg');
		Route::post('chat-history', 'ChatController@chatHistory')->name('chat-history');
		Route::post('delete-single-msg', 'ChatController@deleteSingleMsg')->name('delete-single-msg');
		Route::post('friends-list', 'ChatController@friendsList')->name('friends-list');
		...
		// Route::post('fetch-video-description','VideoController@fetchVideoDescription')->name('fetch-video-description');
